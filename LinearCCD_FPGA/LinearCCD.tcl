...
# File: LinearCCD.tcl
# Generated on: Tue Aug 15 13:03:06 2023
...
if {[is_project_open]} {
	if {[string compare $quartus(project) "LinearCCD"]} {
		puts "Project LinearCCD is not open"
		set make_assignments 0
	}
} else {
	# Only open if not already open
	if {[project_exists LinearCCD]} {
		project_open -revision LinearCCD LinearCCD
	} else {
		project_new -revision LinearCCD LinearCCD
	}
